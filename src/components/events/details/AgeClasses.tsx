...
export default function AgeClasses({ classes }: { classes: any[] }) {
  return (
    <div className="bg-card rounded-[20px] p-8 md:p-10 shadow-[0_10px_30px_rgba(0,0,0,0.06)] border border-gray-50 mb-[80px]">
      <h2 className="text-muted-foregroundxl font-extrabold text-[#0F172A] mb-8">Age Classes</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {classes.map((cls, i) => (
          <motion.div 
            ...
            viewport={{ once: true }}
            className="flex items-center gap-4 p-5 bg-[#F8FAFC] border border-border rounded-[16px] hover:border-brand-orange/30 transition-colors"
          >
            ...
            <div>
              <h4 className="font-extrabold text-[#0F172A] text-lg">{cls.name}</h4>
