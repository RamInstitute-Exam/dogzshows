...
export default function EventSponsors() {
  ...
  return (
    <div className="bg-card rounded-[20px] p-8 md:p-10 shadow-[0_10px_30px_rgba(0,0,0,0.06)] border border-gray-50 mb-[80px]">
      <h2 className="text-muted-foregroundxl font-extrabold text-[#0F172A] mb-8 text-center">Our Sponsors</h2>
      
      <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
        {sponsors.map((sponsor, i) => (
          <div key={i} className="flex flex-col items-center justify-center p-6 bg-[#F8FAFC] rounded-2xl border border-border hover:border-brand-orange/30 transition-colors">
