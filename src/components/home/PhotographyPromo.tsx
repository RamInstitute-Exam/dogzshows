      ...
      <div className="w-full max-w-[1600px] mx-auto px-4 sm:px-6 md:px-8 lg:px-10 xl:px-12 relative z-10">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}>
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-card backdrop-blur-md border border-border text-sm font-bold text-brand-orange mb-6">
              <Sparkles className="w-4 h-4" /> Professional Coverage
            </div>
            
            <h2 className="text-4xl md:text-5xl font-extrabold text-foreground tracking-tight leading-[1.1] mb-6">
              Capture Every <br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-brand-orange to-yellow-400">Champion Moment.</span>
            </h2>
            ...
            <div className="space-y-6 mb-10">
              {[
                ...
                <div key={i} className="flex gap-4 items-start group">
                  <div className="p-3 rounded-2xl bg-card border border-border text-brand-orange group-hover:bg-brand-orange group-hover:text-foreground transition-colors">
            ...
            <Button className="group h-auto px-[32px] py-[16px] text-[18px] btn-primary-luxury rounded-full border-0">
              Book Photography Session <ArrowRight className="ml-2 w-5 h-5 text-foreground group-hover:translate-x-[6px] transition-transform duration-300" />
            </Button>
          </motion.div>
          ...
          >
            ...
            <div className="space-y-4 -translate-y-4">
              ...
              <div className="bg-gradient-to-br from-brand-orange to-red-500 rounded-3xl w-full h-64 p-8 flex flex-col justify-end text-foreground border-4 border-border">
                <Camera className="w-12 h-12 mb-4 opacity-50" />
                <h3 className="text-2xl font-bold mb-2">Winner Portraits</h3>
                <p className="text-orange-100 text-sm">Studio-grade lighting at the podium.</p>
              </div>
            </div>
          </motion.div>
