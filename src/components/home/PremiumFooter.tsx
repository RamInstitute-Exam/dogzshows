    ...
    <footer className="bg-background pt-24 pb-12 border-t border-border">
      <div className="w-full max-w-[1600px] mx-auto px-4 sm:px-6 md:px-8 lg:px-10 xl:px-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 mb-16">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center gap-2 mb-6">
              <Image src="/Untitled-1.png" alt="JuzDog" width={180} height={50} className="w-[180px] h-auto object-contain" />
            </div>
            ...
            <div className="flex gap-4">
              {[1, 2, 3, 4].map((_, i) => (
                <a key={i} href="#" className="w-10 h-10 rounded-full bg-[#0B1220] flex items-center justify-center text-[#CBD5E1] hover:bg-[#F59E0B] hover:text-foreground transition-colors border border-border">
          ...
          <div>
            ...
            <ul className="space-y-4">
              {['Home', 'Events', 'Judges', 'Gallery', 'Winners Hall'].map(link => (
                <li key={link}>
                  <Link href="#" className="text-[#CBD5E1] hover:text-foreground transition-colors">{link}</Link>
                </li>
              ))}
            </ul>
          </div>
        ...
        <div className="pt-8 border-t border-border flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-[#64748B] text-sm font-[500]">© {new Date().getFullYear()} JuzDog Management Platform. All rights reserved.</p>
          <div className="flex gap-6 text-sm font-[500]">
            <Link href="#" className="text-[#64748B] hover:text-foreground transition-colors">Privacy Policy</Link>
            <Link href="#" className="text-[#64748B] hover:text-foreground transition-colors">Terms of Service</Link>
          </div>
        </div>
