          ...
          {WINNERS.map((winner, i) => (
            ...
            >
              ...
              <div className="h-[120px] sm:h-[160px] lg:h-[220px] relative overflow-hidden shrink-0">
                <OptimizedImage src={winner.image} alt={winner.dog} className="w-full h-full object-contain bg-[#fcfcfc] transition-transform duration-700 group-hover:scale-110" />
