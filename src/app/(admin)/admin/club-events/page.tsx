              ...
              <table className="w-full text-left border-collapse">
                <thead>
                  <tr className="bg-card border-b border-border text-muted-foreground uppercase text-xs tracking-wider">
                    ...
                    <th className="p-4 font-semibold capitalize">venue</th>
                    <th className="p-4 font-semibold capitalize">startDate</th>
                    <th className="p-4 font-semibold capitalize">endDate</th>
                ...
                <tbody className="divide-y divide-[rgba(255,255,255,0.05)]">
                  {data.map((item) => (
                    <tr key={item.id} className="hover:bg-accent transition-colors">
                      ...
                      <td className="p-4 text-foreground font-bold">{item.venue}</td>
                      <td className="p-4 text-foreground font-bold">{item.startDate}</td>
                      <td className="p-4 text-foreground font-bold">{item.endDate}</td>
