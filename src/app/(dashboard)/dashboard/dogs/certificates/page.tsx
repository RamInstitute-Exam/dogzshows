  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 bg-card p-6 rounded-2xl border border-border shadow-sm">
        <div>
          <h1 className="text-2xl font-extrabold text-foreground tracking-tight">Certificates</h1>
          <p className="text-muted-foreground text-sm mt-1">Manage and view your certificates records.</p>
        </div>
      ...
      <div className="bg-card rounded-2xl border border-border shadow-sm overflow-hidden min-h-[400px]">
        {data.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-24 text-center">
            ...
            <p className="text-muted-foreground max-w-sm mb-6">There are currently no certificates records available in this section. Start by creating a new entry.</p>
