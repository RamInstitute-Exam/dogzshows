    ...
    <ProtectedRoute>
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12 w-full">
        <div className="mb-8">
          ...
          <h1 className="text-muted-foregroundxl font-bold text-foreground">Edit Dog Profile</h1>
        </div>
        ...
        <div className="bg-card rounded-3xl shadow-sm border border-border overflow-hidden">
          <form onSubmit={handleSubmit} className="p-8 space-y-8">
            ...
            <div>
              <label className="block text-sm font-medium text-muted-foreground mb-4">Photos (Up to 5 total)</label>
              ...
              {existingImages.length < 5 && (
                <>
                  <p className="text-xs text-muted-foreground mb-2">Add New Photos:</p>
