    ...
    <ProtectedRoute>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 w-full min-h-screen">
        ...
        <div className="mb-10">
          ...
          <p className="text-sm text-gray-500 font-medium mt-0.5">Upgrade Breeder listing limits, activate search spotlights, and unlock advanced lead analytics.</p>
        </div>
        ...
        {loading ? (
          ...
          <div className="space-y-10">
            ...
            <div className="bg-white p-6 rounded-3xl border border-gray-200/60 shadow-sm flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
              <div>
                <p className="text-2xs font-bold text-gray-400 uppercase tracking-wider">Account Active Tier</p>
                <div className="flex items-center space-x-2 mt-1">
                  <h3 className="text-2xl font-extrabold text-gray-900">{currentPlan} Membership</h3>
                  {currentPlan !== 'FREE' && (
                    <span className="inline-flex items-center px-2 py-0.5 rounded text-3xs font-extrabold bg-green-100 text-green-800 border border-green-200">
                      <ShieldCheck className="w-3.5 h-3.5 mr-0.5" /> Active
                    </span>
                  )}
                </div>
                {expiryDate && (
                  <p className="text-xs text-gray-500 font-semibold mt-1">Renews on: {new Date(expiryDate).toLocaleDateString()}</p>
                )}
              </div>
              <div className="text-xs font-semibold text-gray-500 max-w-sm">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              {/* PLAN 1: FREE */}
              <div className={`bg-white p-6 rounded-3xl border shadow-sm flex flex-col justify-between h-[55vh] ${
                currentPlan === 'FREE' ? 'border-indigo-600 ring-2 ring-indigo-500/20' : 'border-gray-200/60'
              }`}>
                <div>
                  <h4 className="text-xs font-bold text-gray-400 uppercase tracking-wider mb-2">Basic Starter</h4>
                  <h3 className="text-xl font-extrabold text-gray-900">Free Tier</h3>
                  <div className="flex items-baseline mt-4">
                    <span className="text-4xl font-extrabold text-gray-900 tracking-tight">INR 0</span>
                    <span className="text-gray-500 text-xs font-semibold ml-1">/month</span>
                  </div>
                  <ul className="mt-6 space-y-3.5 text-xs text-gray-600 font-semibold">
                ...
                <button
                  disabled
                  className="w-full bg-gray-50 text-gray-500 font-semibold py-3 rounded-xl border border-gray-200 text-xs text-center cursor-not-allowed mt-8"
                >
              ...
              {/* PLAN 2: PRO */}
              <div className={`bg-white p-6 rounded-3xl border shadow-sm flex flex-col justify-between h-[55vh] relative ${
                currentPlan === 'PRO' ? 'border-indigo-600 ring-2 ring-indigo-500/20' : 'border-gray-200/60'
              }`}>
                <span className="absolute -top-3.5 left-6 bg-gradient-to-r from-indigo-600 to-purple-600 text-white text-3xs font-extrabold px-3 py-1 rounded-full shadow-sm">
                  Recommended
                </span>
                <div>
                  <h4 className="text-xs font-bold text-gray-400 uppercase tracking-wider mb-2">Market Breeder</h4>
                  <h3 className="text-xl font-extrabold text-gray-900 flex items-center space-x-1">
                    <span>Professional</span>
                    <Sparkles className="w-4.5 h-4.5 text-indigo-600" />
                  </h3>
                  <div className="flex items-baseline mt-4">
                    <span className="text-4xl font-extrabold text-gray-900 tracking-tight">INR 499</span>
                    <span className="text-gray-500 text-xs font-semibold ml-1">/month</span>
                  </div>
                  <ul className="mt-6 space-y-3.5 text-xs text-gray-600 font-semibold">
                    <li className="flex items-center space-x-2">
                ...
                <button
                  ...
                  className="w-full bg-indigo-600 hover:bg-indigo-700 disabled:opacity-55 text-white font-bold py-3 rounded-xl transition-all shadow-md text-xs text-center cursor-pointer flex justify-center items-center mt-8"
                >
                  {checkingOutPlan === 'PRO' ? (
              ...
              {/* PLAN 3: ENTERPRISE */}
              <div className={`bg-white p-6 rounded-3xl border shadow-sm flex flex-col justify-between h-[55vh] ${
                currentPlan === 'ENTERPRISE' ? 'border-indigo-600 ring-2 ring-indigo-500/20' : 'border-gray-200/60'
              }`}>
                <div>
                  <h4 className="text-xs font-bold text-gray-400 uppercase tracking-wider mb-2">Corporate Registry</h4>
                  <h3 className="text-xl font-extrabold text-gray-900">Enterprise</h3>
                  <div className="flex items-baseline mt-4">
                    <span className="text-4xl font-extrabold text-gray-900 tracking-tight">INR 1,999</span>
                    <span className="text-gray-500 text-xs font-semibold ml-1">/month</span>
                  </div>
                  <ul className="mt-6 space-y-3.5 text-xs text-gray-600 font-semibold">
                    <li className="flex items-center space-x-2">
