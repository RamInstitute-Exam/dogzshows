...
export default function DogProfileClient() {
  ...
  if (loading) {
    return (
      <div className="flex flex-col justify-center items-center min-h-[70vh]">
        ...
        <p className="text-gray-500 text-xs font-semibold">Loading companion profile...</p>
      </div>
    );
  }
  ...
  if (!dog) {
    return (
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 text-center">
        <h1 className="text-3xl font-bold text-gray-900 mb-4">Companion Profile Not Found</h1>
  ...
  return (
    <div className="bg-slate-50/50 min-h-screen pb-24">
      {/* Toast Notification */}
      {toast && (
        <div className="fixed bottom-6 right-6 z-50 bg-slate-900 text-white p-4.5 p-4 rounded-2xl shadow-xl flex items-center space-x-2 animate-in fade-in slide-in-from-bottom-5 duration-300">
      ...
      <div className="bg-gradient-to-br from-indigo-950 via-slate-900 to-purple-950 pt-8 pb-36">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <Link href="/dogs" className="inline-flex items-center text-indigo-300 hover:text-white transition-colors mb-6 text-xs font-bold uppercase tracking-wider">
            <ArrowLeft className="w-4 h-4 mr-2" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-28">
        <div className="bg-white rounded-3xl shadow-xl border border-gray-250 overflow-hidden flex flex-col lg:flex-row">
          
          {/* IMAGE GALLERY COLUMN */}
          <div className="lg:w-1/2 p-6 bg-gray-50/50 flex flex-col justify-between border-r border-gray-150">
            <div>
              <div
                onClick={() => setIsLightboxOpen(true)}
                className="aspect-w-4 aspect-h-3 rounded-2xl overflow-hidden bg-slate-900 shadow-inner h-96 relative cursor-zoom-in group"
              >
                {activeImage ? (
                  <>
                    <img
                    ...
                    <div className="absolute inset-0 bg-slate-950/20 group-hover:bg-slate-950/40 transition-colors flex items-center justify-center">
                      <span className="bg-white/90 backdrop-blur text-gray-900 text-xs px-4 py-2 rounded-xl font-bold shadow-md">Zoom Portrait</span>
                    </div>
                  </>
                ) : (
              ...
              <div className="mt-8 pt-8 border-t border-gray-200">
                ...
                <div className="relative aspect-video bg-black rounded-2xl overflow-hidden shadow-md">
                  ...
                  <button
                    ...
                    className="absolute bottom-3 right-3 p-2 bg-slate-950/80 backdrop-blur rounded-xl text-white transition-all border border-white/10"
            ...
            <div>
              <div className="flex justify-between items-start gap-4">
                <div>
                  <div className="flex flex-wrap items-center gap-2">
                    ...
                    {dog.registered && (
                      <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-3xs font-extrabold bg-indigo-50 text-indigo-700 border border-indigo-100 uppercase tracking-wider">
                ...
                <div className="flex space-x-2">
                  ...
                  <button
                    onClick={handleShare}
                    className="p-3 bg-slate-50 text-slate-500 rounded-full hover:bg-slate-100 transition-all cursor-pointer shadow-xs border border-gray-200"
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mt-8">
                ...
                <div className="bg-slate-50 p-3.5 rounded-2xl border border-gray-250/60 text-center">
                  ...
                  <p className="font-extrabold text-gray-900 mt-1">{dog.weight || 15} kg</p>
                </div>
                <div className="bg-slate-50 p-3.5 rounded-2xl border border-gray-250/60 text-center">
                  <p className="text-3xs text-gray-400 font-bold uppercase tracking-wider">Coat Color</p>
                  <p className="font-extrabold text-gray-900 mt-1 truncate">{dog.color || 'Fawn Cream'}</p>
                </div>
              </div>
              ...
              {dog.personality && dog.personality.length > 0 && (
                <div className="mt-8">
                  <h3 className="text-4xs font-bold uppercase tracking-wider text-gray-400 mb-3 flex items-center space-x-1">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {dog.personality.map((trait, idx) => (
                      <span
                        key={idx}
                        className="bg-orange-50 text-orange-650 border border-orange-100 text-3xs font-extrabold rounded-xl px-3 py-1 uppercase tracking-wider"
                      >
                        {trait}
                      </span>
                    ))}
              ...
              <div className="mt-8 bg-slate-50 border border-gray-250 p-5 rounded-3xl space-y-4">
                <div className="flex items-center space-x-2 pb-3 border-b border-gray-200">
                  ...
                  <div>
                    ...
                    <p className="text-4xs text-gray-400 font-bold uppercase tracking-wider mt-0.5">Verified by Vetting Board</p>
                  </div>
                </div>
              ...
              <div className="mt-8">
                ...
                <p className="text-sm text-gray-600 leading-relaxed whitespace-pre-wrap font-medium">{dog.description}</p>
              </div>
            </div>
            ...
            <div className="mt-10 pt-6 border-t border-gray-200">
              <div className="bg-slate-50 rounded-3xl p-5 border border-gray-250">
                <div className="flex items-center justify-between mb-4.5">
                  <div>
                    <h4 className="text-4xs font-bold text-gray-450 uppercase tracking-wider">Registered Owner</h4>
                    <p className="text-xs font-bold text-gray-950 truncate mt-1">{dog.owner.email}</p>
                  </div>
                  {!isOwner && (
                    <button
                      onClick={() => setIsReportOpen(true)}
                      className="text-gray-400 hover:text-red-650 flex items-center space-x-0.5 text-4xs font-bold uppercase tracking-wider cursor-pointer transition-colors"
                    >
                ...
                {!isOwner ? (
                  <div className="flex flex-col sm:flex-row gap-3">
                    <button
                      ...
                      className="flex-1 bg-orange-500 hover:bg-orange-600 text-white font-bold px-6 py-3.5 rounded-xl transition-all shadow-md text-xs cursor-pointer text-center"
                    >
                      {dog.listingType === 'SALE' ? `Adopt Now - $${dog.price}` : 'Adopt Now - Free'}
                    </button>
                    <button
                      onClick={() => setIsMessageOpen(true)}
                      className="bg-white border border-gray-250 text-gray-700 hover:bg-slate-50 px-4.5 py-3.5 rounded-xl transition-colors cursor-pointer text-xs font-bold flex items-center justify-center space-x-1.5"
                    >
            ...
            {similarDogs.map((sDog) => {
              ...
              return (
                <Link
                  ...
                  className="group bg-white rounded-3xl border border-gray-250 shadow-2xs overflow-hidden flex flex-col hover:shadow-md transition-shadow"
                >
                  <div className="h-44 bg-gray-100 overflow-hidden relative">
                    {simImageSrc ? (
                      ...
                      <div className="bg-orange-50/50 h-full w-full flex items-center justify-center text-orange-200">
                        <span className="font-semibold text-3xs">No Photo</span>
                      </div>
                    )}
                  </div>
                  <div className="p-5 flex flex-col justify-between flex-grow">
                    <div className="flex justify-between items-center">
                      <h4 className="font-bold text-sm text-gray-900 group-hover:text-orange-500 transition-colors">{sDog.name}</h4>
                      <span className="text-3xs text-gray-400 font-bold">{sDog.age} {sDog.age === 1 ? 'year' : 'years'}</span>
                    </div>
                    <div className="mt-4 pt-3 border-t border-gray-100 flex items-center justify-between text-3xs font-extrabold text-orange-500 uppercase tracking-wider">
      ...
      {isLightboxOpen && activeImage && (
        <div className="fixed inset-0 z-50 bg-black/95 backdrop-blur-md flex items-center justify-center p-4 animate-in fade-in duration-200">
          ...
          <div className="max-w-4xl max-h-[85vh] rounded-3xl overflow-hidden border border-white/10 shadow-2xl">
      ...
      {isAdoptionOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/60 backdrop-blur-sm p-4 animate-in fade-in duration-200">
          <div className="bg-white rounded-3xl p-6 md:p-8 w-full max-w-md shadow-2xl border border-gray-250 flex flex-col space-y-5 animate-in zoom-in-95 duration-200">
            <div className="flex justify-between items-center">
            ...
            <form onSubmit={handleSubmitAdoption} className="space-y-4">
              <div>
                <label className="block text-4xs font-bold text-gray-400 uppercase tracking-wider mb-2">Introduction Notes</label>
                <textarea
                  required
                  rows={4}
                  ...
                  className="w-full bg-gray-50 border border-gray-200 focus:bg-white text-gray-950 text-xs rounded-xl p-3.5 focus:outline-none focus:ring-2 focus:ring-orange-500/20 focus:border-orange-500 transition-all font-semibold leading-relaxed"
                />
              </div>
              <div className="flex space-x-3 pt-2">
                <button
                  ...
                  className="w-1/3 bg-gray-50 border border-gray-250 hover:bg-gray-100 text-gray-700 font-semibold py-2.5 rounded-xl text-xs text-center cursor-pointer"
                >
                  Cancel
                </button>
                <button
                  ...
                  className="w-2/3 bg-orange-500 hover:bg-orange-600 disabled:opacity-85 text-white font-bold py-2.5 rounded-xl text-xs shadow-md flex justify-center items-center space-x-1 cursor-pointer"
                >
      ...
      {isMessageOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/60 backdrop-blur-sm p-4 animate-in fade-in duration-200">
          <div className="bg-white rounded-3xl p-6 md:p-8 w-full max-w-md shadow-2xl border border-gray-250 flex flex-col space-y-5 animate-in zoom-in-95 duration-200">
            ...
            <p className="text-xs text-gray-500 font-semibold leading-relaxed">Send a direct message regarding {dog.name} to {dog.owner.email}.</p>
            <form onSubmit={handleSendMessage} className="space-y-4">
              <div>
                <label className="block text-4xs font-bold text-gray-400 uppercase tracking-wider mb-2">Message Content</label>
                <textarea
                  required
                  rows={4}
                  ...
                  className="w-full bg-gray-50 border border-gray-200 focus:bg-white text-gray-955 text-xs rounded-xl p-3.5 focus:outline-none focus:ring-2 focus:ring-orange-500/20 focus:border-orange-500 transition-all font-semibold leading-relaxed"
                />
              </div>
              <div className="flex space-x-3 pt-2">
                <button
      ...
      {isAppointmentOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/60 backdrop-blur-sm p-4 animate-in fade-in duration-200">
          <div className="bg-white rounded-3xl p-6 md:p-8 w-full max-w-md shadow-2xl border border-gray-250 flex flex-col space-y-5 animate-in zoom-in-95 duration-200">
            ...
            <p className="text-xs text-gray-500 font-semibold leading-relaxed">Schedule a consultation time slots with breeder {dog.owner.email}.</p>
            <form onSubmit={handleBookAppointment} className="space-y-4">
              <div>
                <label className="block text-4xs font-bold text-gray-400 uppercase tracking-wider mb-2">Preferred Date & Time</label>
                <input
                  type="datetime-local"
                  required
                  value={apptDate}
                  onChange={(e) => setApptDate(e.target.value)}
                  className="w-full bg-gray-50 border border-gray-200 focus:bg-white text-gray-950 text-xs rounded-xl p-3.5 focus:outline-none focus:ring-2 focus:ring-orange-500/20 focus:border-orange-500 transition-all font-semibold"
                />
              </div>
              <div>
                <label className="block text-4xs font-bold text-gray-400 uppercase tracking-wider mb-2">Consultation Goals</label>
                <textarea
                  rows={3}
                  placeholder="Specify visit expectations (e.g. check socialization, confirm licensing docs)..."
                  value={apptNotes}
                  onChange={(e) => setApptNotes(e.target.value)}
                  className="w-full bg-gray-50 border border-gray-200 focus:bg-white text-gray-900 text-xs rounded-xl p-3.5 focus:outline-none focus:ring-2 focus:ring-orange-500/20 focus:border-orange-500 transition-all font-semibold leading-relaxed"
                />
              </div>
              <div className="flex space-x-3 pt-2">
                <button
                ...
                <button
                  ...
                  className="w-2/3 bg-orange-500 hover:bg-orange-650 disabled:opacity-85 text-white font-bold py-2.5 rounded-xl text-xs shadow-md flex justify-center items-center space-x-1 cursor-pointer"
                >
      ...
      {isReportOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/60 backdrop-blur-sm p-4 animate-in fade-in duration-200">
          <div className="bg-white rounded-3xl p-6 md:p-8 w-full max-w-md shadow-2xl border border-gray-250 flex flex-col space-y-5 animate-in zoom-in-95 duration-200">
            ...
            <p className="text-xs text-gray-500 font-semibold leading-relaxed">Report safety violations or list spam details to the dog board admin panel.</p>
            <form onSubmit={handleFileReport} className="space-y-4">
              <div>
                <label className="block text-4xs font-bold text-gray-400 uppercase tracking-wider mb-2">Abuse Reason</label>
                <textarea
                  required
                  rows={4}
              ...
              <div className="flex space-x-3 pt-2">
                ...
                <button
                  ...
                  className="w-2/3 bg-red-600 hover:bg-red-750 disabled:opacity-85 text-white font-bold py-2.5 rounded-xl text-xs shadow-md flex justify-center items-center space-x-1 cursor-pointer"
                >
