                  ...
                  <Link key={rec.id} href={`/club-details?slug=${rec.slug || rec.id}`} className="group bg-card rounded-2xl border border-border overflow-hidden hover:-translate-y-1 hover:shadow-2xl transition-all duration-300 block">
                    ...
                    <div className="p-5">
                       ...
                       <div className="flex items-center text-xs text-muted-foreground">
                         <MapPin className="w-3 h-3 mr-1" /> {rec.city ? `${rec.city}, ` : ''}{rec.state || 'India'}
                       </div>
                    </div>
                  </Link>
                ))}
      ...
      <section className="relative pt-6 md:pt-8 pb-12 overflow-hidden bg-black border-b border-border">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-10">
          <button 
            ...
            className="flex items-center text-sm font-bold text-muted-foreground hover:text-[#F59E0B] transition-colors mb-8 group bg-black/40 px-3 py-1.5 rounded-lg backdrop-blur-md w-fit"
          >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <AnimatePresence mode="wait">
            ...
            >
              ...
              {activeTab === 'events' && (
                <div>
                  <h2 className="text-2xl font-bold text-foreground mb-6">Club Events</h2>
                        ...
                        <div key={evt.id} className="bg-card rounded-2xl border border-border overflow-hidden group">
                           {evt.banner && (
                             <div className="h-40 bg-accent overflow-hidden">
                               <img src={getImageUrl(evt.banner)} alt={evt.title} className="w-full h-full object-cover group-hover:scale-105 transition-transform" />
                             </div>
                           )}
                           <div className="p-6">
                    ...
                    {club.phone && (
                      <div className="flex gap-4">
                        ...
                        <div>
                          ...
                          <a href={`tel:${club.phone}`} className="text-muted-foreground hover:text-[#F59E0B] transition-colors">{club.phone}</a>
                        </div>
                      </div>
                    )}
                    ...
                    {club.email && (
                      <div className="flex gap-4">
                        ...
                        <div>
                          ...
                          <a href={`mailto:${club.email}`} className="text-muted-foreground hover:text-[#F59E0B] transition-colors">{club.email}</a>
                        </div>
                      </div>
                    )}
                    ...
                    {club.website && (
                      <div className="flex gap-4">
                        ...
                        <div>
                          ...
                          <a href={club.website} target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-[#F59E0B] transition-colors flex items-center gap-1">
